...
| kube-prometheus-stack.grafana.dashboardProviders."dashboardproviders.yaml".providers[0].folder | string | `"Datalayer"` |  |
| kube-prometheus-stack.grafana.dashboardProviders."dashboardproviders.yaml".providers[0].name | string | `"datalayer"` |  |
| kube-prometheus-stack.grafana.dashboardProviders."dashboardproviders.yaml".providers[0].options.path | string | `"/var/lib/grafana/dashboards/datalayer"` |  |
...
| kube-prometheus-stack.grafana.dashboardProviders."dashboardproviders.yaml".providers[1].folder | string | `"Pulsar"` |  |
| kube-prometheus-stack.grafana.dashboardProviders."dashboardproviders.yaml".providers[1].name | string | `"pulsar"` |  |
| kube-prometheus-stack.grafana.dashboardProviders."dashboardproviders.yaml".providers[1].options.path | string | `"/var/lib/grafana/dashboards/pulsar"` |  |
...
| kube-prometheus-stack.grafana.dashboards.datalayer.remote_kernel.bearerToken | string | `""` |  |
| kube-prometheus-stack.grafana.dashboards.datalayer.remote_kernel.datasource | string | `"Prometheus"` |  |
| kube-prometheus-stack.grafana.dashboards.datalayer.remote_kernel.url | string | `"https://raw.githubusercontent.com/datalayer/helm-charts/main/charts/datalayer-observer/dashboards/remote-kernels-details.json"` |  |
| kube-prometheus-stack.grafana.dashboards.datalayer.remote_kernels.bearerToken | string | `""` |  |
| kube-prometheus-stack.grafana.dashboards.datalayer.remote_kernels.datasource | string | `"Prometheus"` |  |
| kube-prometheus-stack.grafana.dashboards.datalayer.remote_kernels.url | string | `"https://raw.githubusercontent.com/datalayer/helm-charts/main/charts/datalayer-observer/dashboards/remote-kernels-overview.json"` |  |
| kube-prometheus-stack.grafana.dashboards.datalayer.services.bearerToken | string | `""` |  |
| kube-prometheus-stack.grafana.dashboards.datalayer.services.datasource | string | `"Prometheus"` |  |
| kube-prometheus-stack.grafana.dashboards.datalayer.services.url | string | `"https://raw.githubusercontent.com/datalayer/helm-charts/main/charts/datalayer-observer/dashboards/datalayer-service.json"` |  |
