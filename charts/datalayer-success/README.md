...
| success.env.DATALAYER_OTEL_API_KEY | string | `""` |  |
...
| success.env.DATALAYER_STRIPE_ORGANIZATION_SEAT_PRICE_LOOKUP_KEY | string | `""` |  |
...
| success.env.OTEL_EXPORTER_OTLP_LOGS_ENDPOINT | string | `"http://datalayer-otel-otel-collector-svc.datalayer-otel.svc.cluster.local:4317"` |  |
| success.env.OTEL_EXPORTER_OTLP_METRICS_ENDPOINT | string | `"http://datalayer-otel-otel-collector-svc.datalayer-otel.svc.cluster.local:4317"` |  |
| success.env.OTEL_EXPORTER_OTLP_TRACES_ENDPOINT | string | `"http://datalayer-otel-otel-collector-svc.datalayer-otel.svc.cluster.local:4317"` |  |
| success.env.OTEL_PYTHON_LOG_LEVEL | string | `"info"` |  |
