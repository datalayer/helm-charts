...
| runtimes.env.DATALAYER_POSTGRESQL_AGENT_MEMORIES_COLLECTION | string | `"agent_memories"` |  |
| runtimes.env.DATALAYER_POSTGRESQL_AGENT_MEMORIES_DATABASE | string | `"mem0"` |  |
| runtimes.env.DATALAYER_POSTGRESQL_AGENT_MEMORIES_HOST | string | `"datalayer-postgresql-agent-memories-rw.datalayer-postgresql.svc.cluster.local"` |  |
| runtimes.env.DATALAYER_POSTGRESQL_AGENT_MEMORIES_NAMESPACE | string | `"datalayer-postgresql"` |  |
| runtimes.env.DATALAYER_POSTGRESQL_AGENT_MEMORIES_PASSWORD | string | `""` |  |
| runtimes.env.DATALAYER_POSTGRESQL_AGENT_MEMORIES_PORT | string | `"5432"` |  |
| runtimes.env.DATALAYER_POSTGRESQL_AGENT_MEMORIES_SECRET | string | `"datalayer-postgresql-agent-memories-app"` |  |
| runtimes.env.DATALAYER_POSTGRESQL_AGENT_MEMORIES_URI | string | `""` |  |
| runtimes.env.DATALAYER_POSTGRESQL_AGENT_MEMORIES_USER | string | `""` |  |
...
| runtimes.env.DATALAYER_RUNTIMES_URL | string | `""` |  |
...
| runtimes.env.DATALAYER_SPACER_URL | string | `"http://datalayer-spacer-svc.datalayer-api.svc.cluster.local:9900"` |  |
...
| runtimes.postgresqlAgentMemories.grantRBAC | bool | `true` |  |
| runtimes.postgresqlAgentMemories.namespace | string | `"datalayer-postgresql"` |  |
| runtimes.postgresqlAgentMemories.secretName | string | `"datalayer-postgresql-agent-memories-app"` |  |
| runtimes.postgresqlAgentMemories.serviceAccountName | string | `"datalayer-runtimes"` |  |
| runtimes.postgresqlAgentMemories.serviceAccountNamespace | string | `"datalayer-api"` |  |
