...
| iam.env.DATALAYER_IAM_URL | string | `""` |  |
...
| iam.env.DATALAYER_OTEL_API_KEY | string | `""` |  |
| iam.env.DATALAYER_PUBSUB_ENGINE | string | `"kafka"` |  |
...
| iam.env.DATALAYER_STRIPE_CUST_PORTAL_ID | string | `""` |  |
| iam.env.DATALAYER_STRIPE_CUST_PORTAL_URL | string | `""` |  |
...
| iam.env.OTEL_EXPORTER_OTLP_LOGS_ENDPOINT | string | `"http://datalayer-otel-otel-collector-svc.datalayer-otel.svc.cluster.local:4317"` |  |
| iam.env.OTEL_EXPORTER_OTLP_METRICS_ENDPOINT | string | `"http://datalayer-otel-otel-collector-svc.datalayer-otel.svc.cluster.local:4317"` |  |
| iam.env.OTEL_EXPORTER_OTLP_TRACES_ENDPOINT | string | `"http://datalayer-otel-otel-collector-svc.datalayer-otel.svc.cluster.local:4317"` |  |
| iam.env.OTEL_PYTHON_LOG_LEVEL | string | `"info"` |  |
| iam.env.OTEL_SDK_DISABLED | string | `"false"` |  |
| iam.image | string | `"datalayer/iam:1.1.2"` |  |
