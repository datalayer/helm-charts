...
| scheduler.env.AWS_ACCESS_KEY_ID | string | `""` |  |
| scheduler.env.AWS_DEFAULT_REGION | string | `""` |  |
| scheduler.env.AWS_SECRET_ACCESS_KEY | string | `""` |  |
| scheduler.env.DATALAYER_CORS_ORIGIN | string | `"*"` |  |
| scheduler.env.DATALAYER_IAM_URL | string | `"http://datalayer-iam-svc.datalayer-api.svc.cluster.local:9700"` |  |
